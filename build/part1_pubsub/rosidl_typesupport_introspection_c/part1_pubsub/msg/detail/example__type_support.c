...
static rosidl_typesupport_introspection_c__MessageMember part1_pubsub__msg__Example__rosidl_typesupport_introspection_c__Example_message_member_array[1] = {
  {
    ...
    offsetof(part1_pubsub__msg__Example, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
